...
def getStats(duration="all", days=None):
    ...
    if duration == 'all' and days == None:
        ...
        print(f"Current stake weight   : {convertFromSat(int(getColdStakingInfo()['currently_staking'])):,} | {round(getColdStakingInfo()['currently_staking'] / convertFromSat(int(getStakingInfo()['netstakeweight']))*100, 2)}%")
