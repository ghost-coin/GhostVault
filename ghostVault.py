...
def getStats(duration="all", days=None):
    ...
    if duration == 'all' and days == None:
        ...
        print(f"Current stake weight   : {getColdStakingInfo()['currently_staking']:,} | {getColdStakingInfo()['currently_staking'] / convertFromSat(int(getStakingInfo()['netstakeweight']))*100, 2)}%")
